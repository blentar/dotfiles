...
theme.border_normal                             = "#d79921"
theme.border_focus                              = "#fabd2f"
theme.border_marked                             = "#83a598"
theme.titlebar_bg_focus                         = "#fabd2f"
theme.titlebar_bg_normal                        = "#d79921"
    ...
    s.mywibox:setup {
        ...
        { -- Right widgets
           ...
           -- wibox.container.background(wibox.container.margin(wibox.widget { mailicon, mail and mail.widget, layout = wibox.layout.align.horizontal }, 4, 7), "#343434"),
            arrow("alpha", "#83a598"),
            wibox.container.background(wibox.container.margin(wibox.widget { memicon, mem.widget, layout = wibox.layout.align.horizontal }, 2, 3), "#83a598"),
            arrow("#83a598", "#8ec07c"),
...
--            arrow("#7197E7", "#A77AC4"),
            wibox.container.background(wibox.container.margin(clock, 4, 8), "#83a598"),
            arrow("#83a598", "alpha"),
            --]]
            s.mylayoutbox,
        },
