...
# Source plugins.
source ~/gitstuff/zsh-plugins/zsh-autosuggestions/zsh-autosuggestions.zsh
source ~/gitstuff/zsh-plugins/zsh-syntax-highlighting/zsh-syntax-highlighting.zsh 2>/dev/null
